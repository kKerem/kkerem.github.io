...
const darkTheme = "dark";
    ...
    const darkThemeSetUp = () => {
        if (getCurrentTheme() === "dark") {
            ...
            $(".switch").html('<i class="fas fa-sun fa-sm"></i><span class="d-md-none ps-2">Light Mode</span>')
        } else {
            document.getElementById("toggleBtn").checked = false;
            $(".switch").html('<i class="fas fa-moon fa-sm"></i><span class="d-md-none ps-2">Dark Mode</span>')
        }
    };
